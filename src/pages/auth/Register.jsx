      ...
      <form className="space-y-4">
        ...
        <div className="flex items-center gap-2 py-2">
          <input
            type="checkbox"
            id="terms"
            className="w-3.5 h-3.5 rounded border-gray-300 text-[#6B7CFF] focus:ring-[#6B7CFF]"
          />
          <label htmlFor="terms" className="text-[11px] text-gray-400">
            Accept <span className="text-[#6B7CFF] cursor-pointer hover:underline">terms and conditions</span>
          </label>
        </div>
